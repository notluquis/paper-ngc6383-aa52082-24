...
a.axvline(mu_d,color="black",ls="-.",lw=1,label=r"$d_\mathrm{{mode}}={:.3f}\pm{:.3f}$ kpc".format(mu_d,std_d))
a.axvspan(mu_d-std_d,mu_d+std_d,color="#999999",alpha=0.2,lw=0,label="Distance dispersion")
